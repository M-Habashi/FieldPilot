...
Dropzone.options.photodropzone = {
  init: function() {
    this.on("addedfile", function(file) { document.getElementById('dzarea').style.display = 'none'; document.getElementById('slideshow').style.display = 'block'; });
