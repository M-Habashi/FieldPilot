...
export function fieldPilotInstructions(context?: FieldPilotChatContext) {
  const lines = [
    ...
    'This release is read-only. Never claim that you created, changed, assigned, completed, deleted, sent, or scheduled anything.',
